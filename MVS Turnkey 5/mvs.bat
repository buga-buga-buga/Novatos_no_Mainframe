...
COPY /Y local_conf\tk5.parm .\parm.bat
CALL parm.bat
...
CALL .\Customizadas_do_Buga\log_rotarion.bat
SET HERCULES_RC=scripts\ipl.rc
SET TK5CRLF=CRLF
IF "x%DAEMON%" equ "x" .\hercules\windows\%ARCH%\hercules %DAEMON% -f conf\tk5.cnf -o log/hercules.log >log/3033.log
